  ...
  methods: {
    getEcharts() {
     ...
     //设置一些可选的参数
      var option = {
        ...
        series: [
          ...
          },
          {
            ...
            data: this.convertData1(this.data)
          }
        ]
      };
      // 使用刚指定的配置项和数据显示图表。
      ...
      //定义数据
      this.dataArray[0] = [{ name: "上海", value: "广州" }];
      this.dataArray[1] = [{ name: "上海", value: "北京" }];
      this.dataArray[2] = [{ value: "深圳" }];
      this.dataArray[3] = [{ name: "上海", value: "天津" }];
      this.dataArray[4] = [{ name: "上海", value: "唐山" }];
    },
    ...
    convertData(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        var toCoord = this.geoCoordMap[data[i].value]; //获取城市的坐标
    ...
    nocease() {
      //随机取1-5
      this.data = this.dataArray[this.globalIndex % 5];
      this.globalIndex++;
      var option = this.myChart.getOption();
      if (this.data[0].name) {
        option.series[0].data = this.convertData(this.data);
        option.series[1].data = this.convertData1(this.data);
      } else {
